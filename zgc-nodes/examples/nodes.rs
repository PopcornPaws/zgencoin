...
fn main() -> Result<(), String> {
    ...
    let mut miner_2 = Miner::new(ip_2, &[ip_0, ip_1, ip_3], hasher, 1, 5, miner2_priv_key)?;
    let mut thin_node = ThinNode::new(ip_3, &[ip_0, ip_1, ip_2], thin_node_priv_key)?;

    let recipient = Address::try_from_str("15b1b4630260bda6d9074fc398bae619aaaf561d").unwrap();
    //thin_node.new_transaction(10_000, recipient, thin_node_priv_key)?;
